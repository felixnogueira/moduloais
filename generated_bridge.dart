...
class ModuloaisImpl implements Moduloais {
  final ModuloaisPlatform _platform;
  factory ModuloaisImpl(ExternalLibrary dylib) =>
      ModuloaisImpl.raw(ModuloaisPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory ModuloaisImpl.wasm(FutureOr<WasmModule> module) =>
      ModuloaisImpl(module as ExternalLibrary);
  ModuloaisImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
  ...
  Future<void> sessionSend2Fa(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_session_send2fa(port_, arg0, arg1),
      parseSuccessData: _wire2api_unit,
      constMeta: kSessionSend2FaConstMeta,
      argValues: [sessionId, code],
      hint: hint,
    ));
  }
...
class ModuloaisPlatform extends FlutterRustBridgeBase<ModuloaisWire> {
  ModuloaisPlatform(ffi.DynamicLibrary dylib) : super(ModuloaisWire(dylib));
...
class ModuloaisWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  ModuloaisWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ModuloaisWire.fromLookup(
  ...
  late final _wire_session_send2faPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_session_send2fa');
