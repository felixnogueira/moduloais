...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the network..."),
        ...
        ("Slogan_tip", "Innovative solutions for development"),
        ...
        ("install_tip", "Due to UAC, Modulo AIS can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Modulo AIS to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Modulo AIS \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Modulo AIS \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Modulo AIS to use the \"Accessibility\" service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Modulo AIS application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Modulo AIS \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Modulo AIS \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Modulo AIS."),
        ...
        ("verify_rustdesk_password_tip", "Verify Modulo AIS password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Modulo AIS and start the service, do not proceed and hang up immediately."),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Modulo AIS from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by AIS Labs"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Modulo AIS window is open"),
        ...
        ("floating_window_tip", "It helps to keep Modulo AIS background service"),
