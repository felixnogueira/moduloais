...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à Modulo AIS."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à Modulo AIS l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser Modulo AIS à utiliser le service \"Accessibilité\"."),
        ...
        ("Language", "Langue"),
        ("Keep Modulo AIS background service", "Gardez le service Modulo AIS en arrière plan"),
        ...
        ("Show Modulo AIS", "Afficher Modulo AIS"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à Modulo AIS l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à Modulo AIS les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de Modulo AIS en cours d'éxécution."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe Modulo AIS"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser Modulo AIS et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher Modulo AIS de fonctionner correctement en tant que machine contrôlé."),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre Modulo AIS est ouverte"),
