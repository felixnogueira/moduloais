...
class MyTheme {
  ...
  static const Color accent = Color(0xFF0798fe);
  static const Color accent50 = Color(0x770798fe);
  static const Color accent80 = Color(0xAA0798fe);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFF084aa9);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF5E0D99);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFF5E0D99);
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing ModuloAIS...");
...
Widget loadPowered(BuildContext context) {
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://aislabs.io'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
