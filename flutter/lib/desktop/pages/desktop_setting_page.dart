    ...
    return futureBuilder(future: () async {
      ...
      return DesktopScrollWrapper(
          ...
          child: SingleChildScrollView(
            ...
            child: _Card(title: '${translate('About')} Modulo AIS', children: [
              ...
              Column(
                ...
                children: [
                  ...
                  InkWell(
                      onTap: () {
                        launchUrlString('https://aislabs.io/privacy.html');
                      },
                      child: Text(
                  ...
                  InkWell(
                      onTap: () {
                        launchUrlString('https://aislabs.io');
                      },
                      child: Text(
                        translate('Website'),
                        style: linkStyle,
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Copyright © ${DateTime.now().toString().substring(0, 4)} AIS Labs Ltd.\n$license',
